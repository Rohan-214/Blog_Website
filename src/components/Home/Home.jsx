        ...
        <>
            ...
            <div className="bg-[#F7EFE8]  ">
                <div className="flex flex-col sm:flex-row  justify-center items-center h-screen ">
                    <img className=" rounded-l-full rounded-tr-full border-5  border-[#2F5E64] lg:w-120 lg:h-80 w-100 h-60 "
                    ...
                    <div className="text-end" >
                        <div className="text-6xl lg:text-8xl font-semibold mb-5 items-start text-[#2F5E64]">Write your
                            <span className="text-[#BC7E6C]"><br />Article<br /></span>
                            <Link to="/addArticles" className="text-[#BC7E6C] lg:text-8xl font-semibold underline-offset-10 underline hover:text-[#2F5E64]">here</Link>
                        </div>
                    </div>
                </div>
            </div> 
