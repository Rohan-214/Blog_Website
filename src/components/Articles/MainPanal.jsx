    ...
    return (
        <>
            <div className="flex flex-wrap justify-between gap-3">
                <div className="flex min-w-0 flex-wrap gap-5">
                    <div className="flex items-center gap-1">
                        ...
                        <div className="wrap-break-word font-medium" >{userName}</div>
                    </div>
            ...
            <div className="px-2 sm:px-6 lg:px-20" >
                ...
                <img className="mt-5 h-auto w-full max-w-3xl object-cover" src={topicPhoto} alt={title} />
                <div className="font-light mb-5 text-sm">{description}</div>
            </div>
            <div className="px-2 text-lg sm:px-6 sm:text-xl lg:px-10">{content}</div>
        </>
    );
}
